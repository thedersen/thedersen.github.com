...
//			case 32: // Space = +1; Shift + Space = -1
      ...
      case 82: // r
        if(e.ctrlKey){
          ...
          var pre = document.querySelector(window.location.hash + ' pre');
          var output = document.querySelector(window.location.hash + ' .output');

          if(pre && editor){
            output.innerHTML = '';
            var origLog = console.log;
            console.log = function(text){
              output.innerHTML += '<code>' + text + '</code><br>';
            }
            try{
